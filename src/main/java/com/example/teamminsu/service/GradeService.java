...
import com.example.teamminsu.repository.GradeRepository;
...
public class GradeService {
    ...
    public void uploadStudentGrade(String studentNumber, List<GradeCreateRequestDto> gradeRequestDtoList) {
